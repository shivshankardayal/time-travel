...
<xsl:stylesheet version="1.0" xmlns:d="http://docbook.org/ns/docbook"
  ...
  <xsl:template name="user.footer.navigation">
    <br/>
    <p style="text-align: center;">&#xa9;, 2021 Shiv S. Dayal. <a href="http://ashtavakra.org.com">ashtavakra.org</a>.
    Latest Creative Commons license is applicable where not stated.</p>
  </xsl:template>
